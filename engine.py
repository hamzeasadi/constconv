...
def train_step1(model:nn.Module, opt:Optimizer, criterion:nn.Module, loader:DataLoader, dev):
    epoch_loss = 0
    model.train()
    crt1 = nn.L1Loss()
    crt2 = nn.BCEWithLogitsLoss()
